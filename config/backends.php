 ...
 * Local overrides MUST be placed in var/config/turba/backends.local.php or
 * var/config/turba/backends.d/.
 * If the 'vhosts' setting has been enabled in Horde's configuration, you can
 * use var/config/turba/backends-servername.php.
 *
 * Example var/config/turba/backends.local.php configuration file that enables
 * the LDAP address book and adds a composite field to the SQL address book:
 *
 * <?php
