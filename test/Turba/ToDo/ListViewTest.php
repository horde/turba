...
class Turba_ToDo_ListViewTest extends Turba_TestBase
{
    ...
    public function callView_List($method, &$numDisplayed, $param = null)
    {
    ...
    public function test_getAddSources_returns_sources_sorted_by_name()
    {
        ...
        [$addToList, $addToListSources] = $result;
    ...
    public function test_getPage_renders_all_list_items()
    {
    ...
    public function test_getAlpha_renders_filtered_items()
    {
